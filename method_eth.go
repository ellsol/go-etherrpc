...
*/
func (eth Eth) Call(callParams *EthCallParams, quantity *ethertypes.Quantity) (*ethertypes.HexString, error) {
	if quantity == nil {
		quantity = ethertypes.QuantityLatest()
	}
 ...
 */
func (eth Eth) GasPrice() (*ethertypes.EtherValue, error) {
 ...
 */
func (eth Eth) GetBlockByHash(address string, full bool) (*ethertypes.EtherBlock, error) {
 ...
 */
func (eth Eth) GetBlockByNumber(blockNumber *ethertypes.Quantity, full bool) (*ethertypes.EtherBlock, error) {
	return eth.client.RequestEtherBlock(MethodGetBlockByNumber, blockNumber.HexStringOrTag(), full)
}
...
func (eth Eth) GetBlockTransactionCountByNumber(blockNumber int64) (int64, error) {
	return eth.client.RequestInt64(MethodGetBlockTransactionCountByNumber, new(ethertypes.HexString).SetInt64(blockNumber).String())
}
 ...
 */
func (eth Eth) GetCode(address *ethertypes.EtherAddress, quantity *ethertypes.Quantity) (*ethertypes.HexString, error) {
	return eth.client.RequestHexString(MethodGetCode, address.String(), quantity.HexStringOrTag())
}
...
*/
func (eth Eth) GetFilterLogs(filterID string) ([]ethertypes.EtherLog, error) {
...
*/
func (eth Eth) GetLogs(params *NewFilterParams) ([]ethertypes.EtherLog, error) {
	return eth.client.RequestEtherLogList(MethodGetLogs, params.ToMap())
}

/*
	rpc method: "eth_getStorageAt"
	Returns the value from a storage position at a given url.
...
*/
func (eth Eth) GetStorageAt(contractAddress string, index int64, quantity *ethertypes.Quantity) (*ethertypes.HexString, error) {
	return eth.client.RequestHexString(MethodGetStorageAt, contractAddress, new(ethertypes.HexString).SetInt64(index).String(), quantity.String())
}
...
*/
func (eth Eth) GetTransactionByBlockHashAndIndex(hash string, index int64) (*ethertypes.EtherTransaction, error) {
	return eth.client.RequestEtherTransaction(MethodGetTransactionByBlockHashAndIndex, hash, new(ethertypes.HexString).SetInt64(index).String())
}
...
*/
func (eth Eth) GetTransactionByBlockNumberAndIndex(blockNumber int64, index int64) (*ethertypes.EtherTransaction, error) {
	return eth.client.RequestEtherTransaction(MethodGetTransactionByBlockNumberAndIndex, new(ethertypes.HexString).SetInt64(blockNumber).String(), new(ethertypes.HexString).SetInt64(index).String())
}
...
*/
func (eth Eth) GetTransactionByHash(hash string) (*ethertypes.EtherTransaction, error) {
...
*/
func (eth Eth) GetTransactionCount(hash string, quantity *ethertypes.Quantity) (int64, error) {
...
/*
	...
	Returns the number of transactions sent from an url.
...
https://mainnet.infura.io/CnUcPjgWQg4BW4Ozxznl
*/
func (eth Eth) GetTransactionReceipt(hash string) (*ethertypes.EtherTransactionReceipt, error) {
...
*/
func (eth Eth) NewFilter(params *NewFilterParams) (*ethertypes.HexString, error) {
