...
*/
func (personal *Personal) ListAccounts() ([]ethertypes.HexString, error) {
 ...
 */
func (personal *Personal) NewAccount(password string) (*ethertypes.HexString, error) {
 ...
 */
func (personal *Personal) SendTransaction(sendTransactionParams *SendTransaction, password string) (*ethertypes.HexString, error) {
